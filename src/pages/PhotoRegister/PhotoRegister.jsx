...
function PhotoRegister() {
    ...
    const handleFileChange = (e) => {
        ...
        fileRef.current.value = ""; // Array에 파일을 옮기고 나면 fileRef는 필요가 없기 대문에 초기화시킴.
    ...
    const handleSubmitClick = () => {
        ...
        const lastId = localStorageFiles.length === 0 
                        ? 0 
                        : localStorageFiles[localStorageFiles.length - 1].id; // localStorageFiles에 아무 것도 없으면 0 -1 이라서 -1 번째 인덱스를 참조할 것이기 때문에 삼항연산자
